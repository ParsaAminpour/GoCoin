...
const (
	OrderInfoService_GetOrderInfo_FullMethodName = "/orderbook.OrderInfoService/GetOrderInfo"
)
...
func (c *orderInfoServiceClient) GetOrderInfo(ctx context.Context, in *OrderInfoRequest, opts ...grpc.CallOption) (*OrderInfoReply, error) {
...
func (UnimplementedOrderInfoServiceServer) GetOrderInfo(context.Context, *OrderInfoRequest) (*OrderInfoReply, error) {
...
func RegisterOrderInfoServiceServer(s grpc.ServiceRegistrar, srv OrderInfoServiceServer) {
	// If the following call pancis, it indicates UnimplementedOrderInfoServiceServer was
...
func _OrderInfoService_GetOrderInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderInfoServiceServer).GetOrderInfo(ctx, req.(*OrderInfoRequest))
	}
...
var OrderInfoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orderbook.OrderInfoService",
...
const (
	GreetingService_Greeting_FullMethodName = "/orderbook.GreetingService/Greeting"
)
...
var GreetingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orderbook.GreetingService",
